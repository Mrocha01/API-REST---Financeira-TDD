...
exports.seed = (knex) => {
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      {id: 10000, name: 'User #1', email: 'user1@example.com', passwd:"$2b$10$XHQ9iKlafRansEIm9STTaOtYwciVxxyboDrMeFeXwOJPuvjU.rVn2"},
      {id: 10001, name: 'User #2', email: 'user2@example.com', passwd:"$2b$10$XHQ9iKlafRansEIm9STTaOtYwciVxxyboDrMeFeXwOJPuvjU.rVn2"}
    ]))
